  ...
  return (
    <div className="space-y-16">
      ...
      <section className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
        <article className="bg-surface p-6 rounded-lg hover:shadow-glow transition-all">
        ...
        <article className="bg-surface p-6 rounded-lg hover:shadow-glow transition-all">
          ...
          <p className="text-muted text-center">
            ...
            Former security analyst turned UX researcher, dedicated to bridging the gap between AI capabilities and human decision-making.
          </p>
        </article>
      </section>
    </div>
